...
const quickActions = [
  { label: "Track Expense", icon: Receipt, prompt: "I spent 200 on groceries today" },
  { label: "Record Loan", icon: HandCoins, prompt: "Lent Sunny 5000" },
  { label: "Create EMI", icon: CalendarClock, prompt: "Add an EMI for my gold loan" },
